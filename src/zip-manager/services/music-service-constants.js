...
const VGM_CONTENT_TYPE = "audio/x-vgm";
const TFMX_CONTENT_TYPE = "audio/x-tfmx";
...
const VGM_FILE_EXTENSION = ".vgm";
const TFMX_FILE_EXTENSION = ".tfmx";
const MUSIC_FILE_CONTENT_TYPES = [
  ...
  { extension: VGM_FILE_EXTENSION, type: VGM_CONTENT_TYPE },
  { extension: TFMX_FILE_EXTENSION, type: TFMX_CONTENT_TYPE }
];
