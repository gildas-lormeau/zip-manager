...
const OPTIONS_HIDE_NAVIGATION_BAR = "Hide navigation bar:";
const OPTIONS_HIDE_DOWNLOAD_MANAGER = "Hide downloads panel:";
const OPTIONS_HIDE_INFOBAR = "Hide bottom bar:";
const OPTIONS_PROMPT_FOR_EXPORT_PASSWORD = "Prompt for password:";
...
export {
  ...
  OPTIONS_HIDE_NAVIGATION_BAR,
  OPTIONS_HIDE_DOWNLOAD_MANAGER,
  OPTIONS_HIDE_INFOBAR,
  OPTIONS_PROMPT_FOR_EXPORT_PASSWORD,
